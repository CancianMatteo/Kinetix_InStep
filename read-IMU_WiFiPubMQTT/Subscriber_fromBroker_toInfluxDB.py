    ...
    try:
        ...
        for i in range(len(ax)):
            point = Point("imu_data") \
                .tag("source", "esp32S3" + data["source"]) \
        ...
        # Log to CSV
        csv_filename = f"{data['time']}_{data['player']}_{data['exercise_type']}_{data['source']}.csv"
